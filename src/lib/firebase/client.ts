 ...
 * `authDomain` = l'hôte courant : les pages d'aide de connexion sont servies via un rewrite
...
export function firebaseAuth(): Auth {
  ...
  if (!app) {
    app =
      ...
      initializeApp({
        ...firebaseConfig,
        authDomain: typeof window !== "undefined" ? window.location.host : `${firebaseConfig.projectId}.firebaseapp.com`,
      });
  }
  return getAuth(app);
}
