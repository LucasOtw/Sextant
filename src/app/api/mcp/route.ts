...
/**
 * Point d'entrée : 429 quand une limite est dépassée, 503 si la vérification de la clé échoue (Firestore), 401 seulement
 * pour une clé absente ou inconnue. Un client MCP ne croit donc pas sa clé révoquée pour une rafale ou une panne passagère.
 */
