...
import { MAX_COLLECTION_NAME } from "@/lib/collections-shared";
...
export function CollectionDialog({ open, onOpenChange, initialName = "", title, description, submitLabel, onSubmit }: Props) {
  return (
...
function NameForm({ initialName, submitLabel, onSubmit, onClose }: { initialName: string; submitLabel: string; onSubmit: (name: string) => Promise<boolean>; onClose: () => void }) {
